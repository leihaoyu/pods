#
#  Be sure to run `pod spec lint TelegramUpdateUI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "TelegramUpdateUI"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of TelegramUpdateUI."
...
Hello
  ...
  spec.homepage     = "/TelegramUpdateUI"
  ...
  spec.source       = { :git => "/TelegramUpdateUI.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "TelegramUpdateUI/**/*.{h,m,swift}"
