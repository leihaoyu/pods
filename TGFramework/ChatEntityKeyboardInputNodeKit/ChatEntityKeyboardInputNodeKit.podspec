#
#  Be sure to run `pod spec lint ChatEntityKeyboardInputNodeKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "ChatEntityKeyboardInputNodeKit"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of ChatEntityKeyboardInputNodeKit."
...
Hello
  ...
  spec.homepage     = "/ChatEntityKeyboardInputNodeKit"
  ...
  spec.source       = { :git => "/ChatEntityKeyboardInputNodeKit.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "ChatEntityKeyboardInputNodeKit/**/*.{h,m,swift}"
  ...
  spec.dependency "MultiplexedVideoNodeKit"
