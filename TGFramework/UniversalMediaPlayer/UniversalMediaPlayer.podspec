#
#  Be sure to run `pod spec lint UniversalMediaPlayer.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "UniversalMediaPlayer"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of UniversalMediaPlayer."
  ...
  spec.homepage     = "http://EXAMPLE/UniversalMediaPlayer"
  ...
  spec.source       = { :git => "/UniversalMediaPlayer.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  ="UniversalMediaPlayer/**/*.{h,m,swift}"
