#
#  Be sure to run `pod spec lint PhotoResources.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "PhotoResources"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of PhotoResources."
...
Hello
  ...
  spec.source       = { :git => "/PhotoResources.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "PhotoResources/**/*.{h,m,swift}"
