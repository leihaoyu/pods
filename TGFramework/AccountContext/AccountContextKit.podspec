#
#  Be sure to run `pod spec lint AccountContextKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "AccountContextKit"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of AccountContextKit."
  ...
  spec.homepage     = "http://EXAMPLE/AccountContextKit"
  ...
  spec.source       = { :git => "http:///AccountContextKit.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "AccountContext/**/*.{h,m,swift}"
