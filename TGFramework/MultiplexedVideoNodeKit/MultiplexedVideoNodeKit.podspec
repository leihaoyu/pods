#
#  Be sure to run `pod spec lint MultiplexedVideoNodeKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "MultiplexedVideoNodeKit"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of MultiplexedVideoNodeKit."
...
Hello
  ...
  spec.homepage     = "/MultiplexedVideoNodeKit"
  ...
  spec.source       = { :git => "/MultiplexedVideoNodeKit.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "MultiplexedVideoNodeKit/**/*.{h,m,swift}"
