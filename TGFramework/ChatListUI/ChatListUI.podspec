#
#  Be sure to run `pod spec lint ChatListUI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "ChatListUI"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of ChatListUI."
...
Hello
  ...
  spec.source       = { :git => "/ChatListUI.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "ChatListUI/**/*.{h,m,swift}"
  ...
  spec.dependency "ChatListFilterSettingsHeaderItemKit"
...
#  spec.dependency "TelegramCallsUI"
  ...
  spec.dependency "ProgressIndicatorComponentKit"
  ...
  spec.dependency "ChatTimerScreenKit"
  ...
  spec.dependency "ChatListTitleViewKit"
