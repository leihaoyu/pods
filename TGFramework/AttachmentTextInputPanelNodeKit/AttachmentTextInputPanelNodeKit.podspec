#
#  Be sure to run `pod spec lint AttachmentTextInputPanelNodeKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "AttachmentTextInputPanelNodeKit"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of AttachmentTextInputPanelNodeKit."
...
Hello
  ...
  spec.homepage     = "/AttachmentTextInputPanelNodeKit"
  ...
  spec.source       = { :git => "/AttachmentTextInputPanelNodeKit.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "AttachmentTextInputPanelNodeKit/**/*.{h,m,swift}"
  ...
  spec.dependency "TextInputMenuKit"
