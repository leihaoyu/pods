#
#  Be sure to run `pod spec lint InstantPageUI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "InstantPageUI"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of InstantPageUI."
...
Hello
  ...
  spec.source       = { :git => "/InstantPageUI.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "InstantPageUI/**/*.{h,m,swift}"
