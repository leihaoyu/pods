#
#  Be sure to run `pod spec lint ChatControllerInteractionKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "ChatControllerInteractionKit"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of ChatControllerInteractionKit."
...
Hello
  ...
  spec.homepage     = "/ChatControllerInteractionKit"
  ...
  spec.source       = { :git => "/ChatControllerInteractionKit.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "ChatControllerInteractionKit/**/*.{h,m,swift}"
