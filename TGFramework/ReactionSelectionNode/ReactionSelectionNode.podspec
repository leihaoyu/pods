#
#  Be sure to run `pod spec lint ReactionSelectionNode.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "ReactionSelectionNode"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of ReactionSelectionNode."
...
Hello
  ...
  spec.homepage     = "/ReactionSelectionNode"
  ...
  spec.source       = { :git => "/ReactionSelectionNode.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "ReactionSelectionNode/**/*.{h,m,swift}"
