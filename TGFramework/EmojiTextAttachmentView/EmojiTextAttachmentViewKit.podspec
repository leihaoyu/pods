#
#  Be sure to run `pod spec lint EmojiTextAttachmentViewKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "EmojiTextAttachmentViewKit"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of EmojiTextAttachmentViewKit."
  ...
  spec.homepage     = "http://EXAMPLE/EmojiTextAttachmentViewKit"
  ...
  spec.source       = { :git => "http:///EmojiTextAttachmentViewKit.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "EmojiTextAttachmentView/**/*.{h,swift,m}"
