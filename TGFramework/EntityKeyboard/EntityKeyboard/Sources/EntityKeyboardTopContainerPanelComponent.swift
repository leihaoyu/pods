...
public final class EntityKeyboardTopContainerPanelEnvironment: Equatable {
    ...
    let visibilityFractionUpdated: ActionSlot<(CGFloat, TGTransition)>
    let isExpandedUpdated: (Bool, TGTransition) -> Void
...
final class EntityKeyboardTopContainerPanelComponent: Component {
    ...
    final class View: UIView {
        ...
        func update(component: EntityKeyboardTopContainerPanelComponent, availableSize: CGSize, state: EmptyComponentState, environment: Environment<EnvironmentType>, transition: TGTransition) -> CGSize {
        ...
        private func updateVisibilityFraction(value: CGFloat, transition: TGTransition) {
        ...
        private func panelIsExpandedUpdated(id: AnyHashable, isExpanded: Bool, transition: TGTransition) {
