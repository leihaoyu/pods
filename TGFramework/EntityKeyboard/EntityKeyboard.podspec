#
#  Be sure to run `pod spec lint EntityKeyboard.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "EntityKeyboard"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of EntityKeyboard."
  ...
  spec.homepage     = "http://EXAMPLE/EntityKeyboard"
  ...
  spec.source       = { :git => "http:///EntityKeyboard.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "EntityKeyboard/**/*.{swift,h,m}"
  ...
  spec.dependency "BlurredBackgroundComponent"
  ...
  spec.dependency "LottieComponentKit"
  spec.dependency "LottieComponentEmojiContent"
  spec.dependency "SoftwareVideo"
  spec.dependency "ShimmerEffect"
