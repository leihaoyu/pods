#
#  Be sure to run `pod spec lint GalleryUI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "GalleryUI"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of GalleryUI."
...
Hello
  ...
  spec.source       = { :git => "/GalleryUI.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "GalleryUI/**/*.{h,m,swift}"
