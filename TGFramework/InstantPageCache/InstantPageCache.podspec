#
#  Be sure to run `pod spec lint InstantPageCache.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "InstantPageCache"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of InstantPageCache."
...
Hello
  ...
  spec.homepage     = "/InstantPageCache"
  ...
  spec.source       = { :git => "/InstantPageCache.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "InstantPageCache/**/*.{h,m,swift}"
