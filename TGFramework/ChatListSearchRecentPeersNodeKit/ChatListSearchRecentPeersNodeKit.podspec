#
#  Be sure to run `pod spec lint ChatListSearchRecentPeersNodeKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "ChatListSearchRecentPeersNodeKit"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of ChatListSearchRecentPeersNodeKit."
...
Hello
  ...
  spec.homepage     = "/ChatListSearchRecentPeersNodeKit"
  ...
  spec.source       = { :git => "/ChatListSearchRecentPeersNodeKit.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "ChatListSearchRecentPeersNodeKit/**/*.{h,m,swift}"
