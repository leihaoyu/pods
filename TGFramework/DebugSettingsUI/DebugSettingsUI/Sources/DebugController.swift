                        ...
                        items.append(ActionSheetButtonItem(title: "Via Telegram", color: .accent, action: { [weak actionSheet] in
                            ...
                            controller.peerSelected = { [weak controller] peer, _ in
                                ...
                                if let strongController = controller {
                                    ...
                                    TGSSZipArchive.createZipFile(atPath: tempZip.path, withFilesAtPaths: [tempSource.path])
                        ...
                        items.append(ActionSheetButtonItem(title: "Via Telegram", color: .accent, action: { [weak actionSheet] in
                            ...
                            controller.peerSelected = { [weak controller] peer, _ in
                                ...
                                if let strongController = controller {
                                    ...
                                    let tempZip = TempBox.shared.tempFile(fileName: "destination.zip")
                                    TGSSZipArchive.createZipFile(atPath: tempZip.path, withFilesAtPaths: tempSources.map(\.path))
