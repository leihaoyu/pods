#
#  Be sure to run `pod spec lint DebugSettingsUI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "DebugSettingsUI"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of DebugSettingsUI."
...
Hello
  ...
  spec.source       = { :git => "/DebugSettingsUI.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "DebugSettingsUI/**/*.{h,m,swift}"
