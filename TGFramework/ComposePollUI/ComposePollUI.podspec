#
#  Be sure to run `pod spec lint ComposePollUI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "ComposePollUI"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of ComposePollUI."
...
Hello
  ...
  spec.source       = { :git => "/ComposePollUI.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "ComposePollUI/**/*.{h,m,swift}"
