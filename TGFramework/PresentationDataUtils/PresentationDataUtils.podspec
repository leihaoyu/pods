#
#  Be sure to run `pod spec lint PresentationDataUtils.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "PresentationDataUtils"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of PresentationDataUtils."
...
Hello
  ...
  spec.homepage     = "/PresentationDataUtils"
  ...
  spec.source       = { :git => "/PresentationDataUtils.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "PresentationDataUtils/**/*.{h,m,swift}"
