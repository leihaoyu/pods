#
#  Be sure to run `pod spec lint ImportStickerPackUI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "ImportStickerPackUI"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of ImportStickerPackUI."
...
Hello
  ...
  spec.homepage     = "/ImportStickerPackUI"
  ...
  spec.source       = { :git => "/ImportStickerPackUI.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "ImportStickerPackUI/**/*.{h,m,swift}"
