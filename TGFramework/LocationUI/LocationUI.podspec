#
#  Be sure to run `pod spec lint LocationUI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "LocationUI"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of LocationUI."
...
Hello
  ...
  spec.source       = { :git => "/LocationUI.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "LocationUI/**/*.{h,m,swift}"
