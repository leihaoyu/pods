#
#  Be sure to run `pod spec lint SelectablePeerNodeKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "SelectablePeerNodeKit"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of SelectablePeerNodeKit."
...
Hello
  ...
  spec.homepage     = "/SelectablePeerNodeKit"
  ...
  spec.source       = { :git => "/SelectablePeerNodeKit.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "SelectablePeerNodeKit/**/*.{h,m,swift}"
