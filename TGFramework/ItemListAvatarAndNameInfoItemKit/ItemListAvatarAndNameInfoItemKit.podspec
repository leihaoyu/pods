#
#  Be sure to run `pod spec lint ItemListAvatarAndNameInfoItemKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "ItemListAvatarAndNameInfoItemKit"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of ItemListAvatarAndNameInfoItemKit."
...
Hello
  ...
  spec.homepage     = "/ItemListAvatarAndNameInfoItemKit"
  ...
  spec.source       = { :git => "/ItemListAvatarAndNameInfoItemKit.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "ItemListAvatarAndNameInfoItemKit/**/*.{h,m,swift}"
