#
#  Be sure to run `pod spec lint CountrySelectionUI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "CountrySelectionUI"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of CountrySelectionUI."
...
Hello
  ...
  spec.homepage     = "/CountrySelectionUI"
  ...
  spec.source       = { :git => "/CountrySelectionUI.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "CountrySelectionUI/**/*.{h,m,swift}"
