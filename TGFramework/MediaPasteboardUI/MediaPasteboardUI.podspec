#
#  Be sure to run `pod spec lint MediaPasteboardUI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "MediaPasteboardUI"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of MediaPasteboardUI."
...
Hello
  ...
  spec.homepage     = "/MediaPasteboardUI"
  ...
  spec.source       = { :git => "/MediaPasteboardUI.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "MediaPasteboardUI/**/*.{h,m,swift}"
