#
#  Be sure to run `pod spec lint StickerResources.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "StickerResources"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of StickerResources."
  ...
  spec.homepage     = "http://EXAMPLE/StickerResources"
  ...
  spec.source       = { :git => "http:///StickerResources.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "StickerResources/**/*.{h,swift,m}"
