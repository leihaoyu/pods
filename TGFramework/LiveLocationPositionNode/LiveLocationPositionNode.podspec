#
#  Be sure to run `pod spec lint LiveLocationPositionNode.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "LiveLocationPositionNode"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of LiveLocationPositionNode."
...
Hello
  ...
  spec.homepage     = "/LiveLocationPositionNode"
  ...
  spec.source       = { :git => "/LiveLocationPositionNode.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "LiveLocationPositionNode/**/*.{h,m,swift}"
