#
#  Be sure to run `pod spec lint Display.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "Display"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of Display."
  ...
  spec.homepage     = "http://EXAMPLE/Display"
  ...
  spec.source       = { :git => "/Display.git", :tag => "#{spec.version}" }
