...
public struct WindowLayout: Equatable {
...
public final class WindowHostView {
    ...
    public let updateSupportedInterfaceOrientations: (UIInterfaceOrientationMask) -> Void
    public let updateDeferScreenEdgeGestures: (UIRectEdge) -> Void
    public let updatePrefersOnScreenNavigationHidden: (Bool) -> Void
    
    public var present: ((ContainableController, PresentationSurfaceLevel, Bool, @escaping () -> Void) -> Void)?
    public var presentInGlobalOverlay: ((_ controller: ContainableController) -> Void)?
    public var addGlobalPortalHostViewImpl: ((PortalSourceView) -> Void)?
    public var presentNative: ((UIViewController) -> Void)?
    public var nativeController: (() -> UIViewController?)?
    public var updateSize: ((CGSize, Double) -> Void)?
    public var layoutSubviews: (() -> Void)?
    public var updateToInterfaceOrientation: ((UIInterfaceOrientation) -> Void)?
    public var isUpdatingOrientationLayout = false
    public var hitTest: ((CGPoint, UIEvent?) -> UIView?)?
    public var invalidateDeferScreenEdgeGesture: (() -> Void)?
    public var invalidatePrefersOnScreenNavigationHidden: (() -> Void)?
    public var invalidateSupportedOrientations: (() -> Void)?
    public var cancelInteractiveKeyboardGestures: (() -> Void)?
    public var forEachController: (((ContainableController) -> Void) -> Void)?
    public var getAccessibilityElements: (() -> [Any]?)?
    
    public init(containerView: UIView, eventView: UIView, isRotating: @escaping () -> Bool, systemUserInterfaceStyle:  Signal<WindowUserInterfaceStyle, NoError>, updateSupportedInterfaceOrientations: @escaping (UIInterfaceOrientationMask) -> Void, updateDeferScreenEdgeGestures: @escaping (UIRectEdge) -> Void, updatePrefersOnScreenNavigationHidden: @escaping (Bool) -> Void) {
...
public class Window1 {
    ...
    public let keyboardViewManager: KeyboardViewManager?
    public var statusBarChangeObserver: AnyObject?
    public var keyboardRotationChangeObserver: AnyObject?
    public var keyboardFrameChangeObserver: AnyObject?
    public var keyboardTypeChangeObserver: AnyObject?
    public var voiceOverStatusObserver: AnyObject?
    
    public var windowLayout: WindowLayout
    private var updatingLayout: UpdatingLayout?
    public var updatedContainerLayout: ContainerViewLayout?
    public var upperKeyboardInputPositionBound: CGFloat?
    ...
    public let topPresentationContext: PresentationContext
