...
public final class WindowRootViewController: UIViewController, UIViewControllerPreviewingDelegate {
...
public final class NativeWindow: UIWindow, WindowHost {
    public var updateSize: ((CGSize) -> Void)?
    public var layoutSubviewsEvent: (() -> Void)?
    public var updateIsUpdatingOrientationLayout: ((Bool) -> Void)?
    public var updateToInterfaceOrientation: ((UIInterfaceOrientation) -> Void)?
    public var presentController: ((ContainableController, PresentationSurfaceLevel, Bool, @escaping () -> Void) -> Void)?
    public var presentControllerInGlobalOverlay: ((_ controller: ContainableController) -> Void)?
    public var addGlobalPortalHostViewImpl: ((PortalSourceView) -> Void)?
    public var hitTestImpl: ((CGPoint, UIEvent?) -> UIView?)?
    public var presentNativeImpl: ((UIViewController) -> Void)?
    public var invalidateDeferScreenEdgeGestureImpl: (() -> Void)?
    public var invalidatePrefersOnScreenNavigationHiddenImpl: (() -> Void)?
    public var invalidateSupportedOrientationsImpl: (() -> Void)?
    public var cancelInteractiveKeyboardGesturesImpl: (() -> Void)?
    public var forEachControllerImpl: (((ContainableController) -> Void) -> Void)?
    public var getAccessibilityElementsImpl: (() -> [Any]?)?
    ...
    public override func _update(toInterfaceOrientation arg1: Int32, duration arg2: Double, force arg3: Bool) {
    ...
    public func present(_ controller: ContainableController, on level: PresentationSurfaceLevel, blockInteraction: Bool, completion: @escaping () -> Void) {
    ...
    public func forEachController(_ f: (ContainableController) -> Void) {
