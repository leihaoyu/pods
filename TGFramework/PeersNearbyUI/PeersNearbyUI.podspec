#
#  Be sure to run `pod spec lint PeersNearbyUI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "PeersNearbyUI"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of PeersNearbyUI."
...
Hello
  ...
  spec.source       = { :git => "/PeersNearbyUI.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "PeersNearbyUI/**/*.{h,m,swift}"
