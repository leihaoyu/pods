...
public struct NetworkInitializationArguments {
    ...
    public init(apiId: Int32, apiHash: String, languagesCategory: String, appVersion: String, voipMaxLayer: Int32, voipVersions: [CallSessionManagerImplementationVersion], appData: Signal<Data?, NoError>, autolockDeadine: Signal<Int32?, NoError>) {
        self.apiId = apiId
        ...
        self.encryptionProvider = OpenSSLEncryptionProvider()
        self.resolvedDeviceName = nil
    }
}
#if os(iOS)
