#
#  Be sure to run `pod spec lint UrlHandling.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "UrlHandling"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of UrlHandling."
  ...
  spec.homepage     = "http://EXAMPLE/UrlHandling"
  ...
  spec.source       = { :git => "/UrlHandling.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  =  "UrlHandling/**/*.{h,m,swift}"
