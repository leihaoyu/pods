#
#  Be sure to run `pod spec lint FetchManagerImplKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "FetchManagerImplKit"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of FetchManagerImplKit."
...
Hello
  ...
  spec.homepage     = "/FetchManagerImplKit"
  ...
  spec.source       = { :git => "/FetchManagerImplKit.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "FetchManagerImplKit/**/*.{h,m,swift}"
