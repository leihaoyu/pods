#
#  Be sure to run `pod spec lint ReactionImageComponent.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "ReactionImageComponent"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of ReactionImageComponent."
  ...
  spec.homepage     = "http://EXAMPLE/ReactionImageComponent"
  ...
  spec.source       = { :git => "http:///ReactionImageComponent.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "ReactionImageComponent/**/*.{h,swift,m}"
