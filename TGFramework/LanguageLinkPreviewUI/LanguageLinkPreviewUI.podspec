#
#  Be sure to run `pod spec lint LanguageLinkPreviewUI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "LanguageLinkPreviewUI"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of LanguageLinkPreviewUI."
...
Hello
  ...
  spec.homepage     = "/LanguageLinkPreviewUI"
  ...
  spec.source       = { :git => "/LanguageLinkPreviewUI.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "LanguageLinkPreviewUI/**/*.{h,m,swift}"
