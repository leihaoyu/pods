#
#  Be sure to run `pod spec lint ItemListAddressItemKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "ItemListAddressItemKit"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of ItemListAddressItemKit."
...
Hello
  ...
  spec.homepage     = "/ItemListAddressItemKit"
  ...
  spec.source       = { :git => "/ItemListAddressItemKit.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "ItemListAddressItemKit/**/*.{h,m,swift}"
