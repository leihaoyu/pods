#
#  Be sure to run `pod spec lint ItemListUI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "ItemListUI"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of ItemListUI."
...
Hello
  ...
  spec.source       = { :git => "/ItemListUI.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "ItemListUI/**/*.{h,m,swift}"
