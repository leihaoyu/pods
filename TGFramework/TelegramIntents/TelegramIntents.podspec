#
#  Be sure to run `pod spec lint TelegramIntents.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "TelegramIntents"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of TelegramIntents."
...
Hello
  ...
  spec.source       = { :git => "/TelegramIntents.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "TelegramIntents/**/*.{h,m,swift}"
