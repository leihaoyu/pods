...
private final class StorageUsageHeaderComponent: Component {
    ...
    class View: UIView {
        ...
        func update(component: StorageUsageHeaderComponent, availableSize: CGSize, state: EmptyComponentState, environment: Environment<Empty>, transition: TGTransition) -> CGSize {
...
final class StorageUsagePanelContainerComponent: Component {
    ...
    let items: [Item]
    let currentPanelUpdated: (AnyHashable, TGTransition) -> Void
    ...
    init(
        ...
        insets: UIEdgeInsets,
        items: [Item],
        currentPanelUpdated: @escaping (AnyHashable, TGTransition) -> Void
    ) {
        self.theme = theme
        self.strings = strings
        self.dateTimeFormat = dateTimeFormat
    ...
    class View: UIView, UIGestureRecognizerDelegate {
        ...
        @objc private func panGesture(_ recognizer: UIPanGestureRecognizer) {
            ...
            case .cancelled, .ended:
                ...
                let transition = TGTransition(animation: .curve(duration: 0.35, curve: .spring))
        ...
        func updateNavigationMergeFactor(value: CGFloat, transition: TGTransition) {
        ...
        func update(component: StorageUsagePanelContainerComponent, availableSize: CGSize, state: EmptyComponentState, environment: Environment<StorageUsagePanelContainerEnvironment>, transition: TGTransition) -> CGSize {
    ...
    func update(view: View, availableSize: CGSize, state: EmptyComponentState, environment: Environment<StorageUsagePanelContainerEnvironment>, transition: TGTransition) -> CGSize {
        return view.update(component: self, availableSize: availableSize, state: state, environment: environment, transition: transition)
    }
}
