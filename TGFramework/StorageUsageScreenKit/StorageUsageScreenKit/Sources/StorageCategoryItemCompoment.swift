...
final class StorageCategoryItemComponent: Component {
    ...
    class View: HighlightTrackingButton {
        ...
        func update(component: StorageCategoryItemComponent, availableSize: CGSize, state: EmptyComponentState, environment: Environment<Empty>, transition: TGTransition) -> CGSize {
