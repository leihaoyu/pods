...
final class StorageKeepSizeComponent: Component {
    ...
    class View: UIView {
        ...
        func update(component: StorageKeepSizeComponent, availableSize: CGSize, state: EmptyComponentState, environment: Environment<Empty>, transition: TGTransition) -> CGSize {
