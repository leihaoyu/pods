#
#  Be sure to run `pod spec lint StorageUsageScreenKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "StorageUsageScreenKit"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of StorageUsageScreenKit."
...
Hello
  ...
  spec.homepage     = "/StorageUsageScreenKit"
  ...
  spec.source       = { :git => "/StorageUsageScreenKit.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "StorageUsageScreenKit/**/*.{h,m,swift}"
  ...
  spec.dependency "PresentationStringsKit"
      ...
      spec.dependency "AnimatedTextComponentKit"
