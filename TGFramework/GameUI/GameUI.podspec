#
#  Be sure to run `pod spec lint GameUI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "GameUI"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of GameUI."
...
Hello
  ...
  spec.source       = { :git => "/GameUI.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "GameUI/**/*.{h,m,swift}"
