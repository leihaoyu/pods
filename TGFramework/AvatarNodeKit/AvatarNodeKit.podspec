#
#  Be sure to run `pod spec lint AvatarNodeKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "AvatarNodeKit"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of AvatarNodeKit."
  ...
  spec.homepage     = "http://EXAMPLE/AvatarNodeKit"
 ...
 spec.platform     = :ios, "11.0"
  ...
  spec.source       = { :git => "http:///AvatarNodeKit.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "AvatarNodeKit/**/*.{h,m,swift}"
