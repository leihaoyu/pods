#
#  Be sure to run `pod spec lint TelegramUniversalVideoContent.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "TelegramUniversalVideoContent"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of TelegramUniversalVideoContent."
...
Hello
  ...
  spec.homepage     = "/TelegramUniversalVideoContent"
  ...
  spec.source       = { :git => "/TelegramUniversalVideoContent.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "TelegramUniversalVideoContent/**/*.{h,m,swift}"
