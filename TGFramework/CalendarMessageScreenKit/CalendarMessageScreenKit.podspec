#
#  Be sure to run `pod spec lint CalendarMessageScreenKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "CalendarMessageScreenKit"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of CalendarMessageScreenKit."
...
Hello
  ...
  spec.homepage     = "/CalendarMessageScreenKit"
  ...
  spec.source       = { :git => "/CalendarMessageScreenKit.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "CalendarMessageScreenKit/**/*.{h,m,swift}"
