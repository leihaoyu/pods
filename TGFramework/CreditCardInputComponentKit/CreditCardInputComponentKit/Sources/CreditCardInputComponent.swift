...
public final class CreditCardInputComponent: Component {
    ...
    public final class View: UIView, STPFormTextFieldDelegate, UITextFieldDelegate {
        ...
        func update(component: CreditCardInputComponent, availableSize: CGSize, state: EmptyComponentState, environment: Environment<Empty>, transition: TGTransition) -> CGSize {
            switch component.dataType {
            case .cardNumber:
