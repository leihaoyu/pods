#
#  Be sure to run `pod spec lint AvatarVideoNodeKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "AvatarVideoNodeKit"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of AvatarVideoNodeKit."
...
Hello
  ...
  spec.homepage     = "/AvatarVideoNodeKit"
  ...
  spec.source       = { :git => "/AvatarVideoNodeKit.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "AvatarVideoNodeKit/**/*.{h,m,swift}"
