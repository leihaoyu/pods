#
#  Be sure to run `pod spec lint JoinLinkPreviewUI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "JoinLinkPreviewUI"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of JoinLinkPreviewUI."
...
Hello
  ...
  spec.homepage     = "/JoinLinkPreviewUI"
  ...
  spec.source       = { :git => "/JoinLinkPreviewUI.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "JoinLinkPreviewUI/**/*.{h,m,swift}"
