...
import InAppPurchaseManagerKit
...
class GSFakeAccountGroupCallContextCache: NSObject, AccountGroupCallContextCache {
...
//        self.cachedGroupCallContexts = AccountGroupCallContextCacheImpl()
        self.cachedGroupCallContexts = GSFakeAccountGroupCallContextCache()
