#
#  Be sure to run `pod spec lint AdUI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "AdUI"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of AdUI."
...
Hello
  ...
  spec.source       = { :git => "/AdUI.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "AdUI/**/*.{h,m,swift}"
