...
@interface TGSSZipArchive ()
- (instancetype)init NS_DESIGNATED_INITIALIZER;
@end

@implementation TGSSZipArchive
{
    /// path for zip file
    NSString *_path;
    zipFile _zip;
...
+ (NSArray<SSZipEntry *> * _Nullable)getEntriesForFileAtPath:(NSString *)path {
    ...
    do {
        ...
        @autoreleasepool {
            ...
            NSString *strPath = [TGSSZipArchive _filenameStringWithCString:filename
...
{
    return [TGSSZipArchive createZipFileAtPath:path withFilesAtPaths:paths withPassword:nil];
}
+ (BOOL)createZipFileAtPath:(NSString *)path withContentsOfDirectory:(NSString *)directoryPath {
    return [TGSSZipArchive createZipFileAtPath:path withContentsOfDirectory:directoryPath withPassword:nil];
}

+ (BOOL)createZipFileAtPath:(NSString *)path withContentsOfDirectory:(NSString *)directoryPath keepParentDirectory:(BOOL)keepParentDirectory {
    return [TGSSZipArchive createZipFileAtPath:path withContentsOfDirectory:directoryPath keepParentDirectory:keepParentDirectory withPassword:nil];
}

+ (BOOL)createZipFileAtPath:(NSString *)path withFilesAtPaths:(NSArray<NSString *> *)paths withPassword:(NSString *)password
{
    TGSSZipArchive *zipArchive = [[TGSSZipArchive alloc] initWithPath:path];
...
+ (BOOL)createZipFileAtPath:(NSString *)path withContentsOfDirectory:(NSString *)directoryPath withPassword:(nullable NSString *)password {
    return [TGSSZipArchive createZipFileAtPath:path withContentsOfDirectory:directoryPath keepParentDirectory:NO withPassword:password];
}


+ (BOOL)createZipFileAtPath:(NSString *)path withContentsOfDirectory:(NSString *)directoryPath keepParentDirectory:(BOOL)keepParentDirectory withPassword:(nullable NSString *)password {
    return [TGSSZipArchive createZipFileAtPath:path
...
- (BOOL)writeFolderAtPath:(NSString *)path withFolderName:(NSString *)folderName withPassword:(nullable NSString *)password
{
    ...
    [TGSSZipArchive zipInfo:&zipInfo setAttributesOfItemAtPath:path];
...
- (BOOL)writeData:(NSData *)data filename:(nullable NSString *)filename compressionLevel:(int)compressionLevel password:(nullable NSString *)password AES:(BOOL)aes
{
    ...
    zip_fileinfo zipInfo = {};
    [TGSSZipArchive zipInfo:&zipInfo setDate:[NSDate date]];
...
{
    NSCalendar *currentCalendar = TGSSZipArchive._gregorian;
