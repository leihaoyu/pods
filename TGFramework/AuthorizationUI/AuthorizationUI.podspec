#
#  Be sure to run `pod spec lint AuthorizationUI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "AuthorizationUI"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of AuthorizationUI."
...
Hello
  ...
  spec.source       = { :git => "/AuthorizationUI.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "AuthorizationUI/**/*.{h,m,swift}"
