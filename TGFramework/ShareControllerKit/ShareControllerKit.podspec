#
#  Be sure to run `pod spec lint ShareControllerKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "ShareControllerKit"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of ShareControllerKit."
...
Hello
  ...
  spec.homepage     = "/ShareControllerKit"
  ...
  spec.source       = { :git => "/ShareControllerKit.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "ShareControllerKit/**/*.{h,m,swift}"
