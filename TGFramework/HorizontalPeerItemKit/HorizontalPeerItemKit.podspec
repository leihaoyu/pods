#
#  Be sure to run `pod spec lint HorizontalPeerItemKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "HorizontalPeerItemKit"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of HorizontalPeerItemKit."
...
Hello
  ...
  spec.homepage     = "/HorizontalPeerItemKit"
  ...
  spec.source       = { :git => "/HorizontalPeerItemKit.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "HorizontalPeerItemKit/**/*.{h,m,swift}"
