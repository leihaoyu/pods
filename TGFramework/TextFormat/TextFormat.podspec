#
#  Be sure to run `pod spec lint TextFormat.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "TextFormat"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of TextFormat."
  ...
  spec.homepage     = "http://EXAMPLE/TextFormat"
  ...
  spec.source       = { :git => "/TextFormat.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "TextFormat/**/*.{h,m,swift}"
