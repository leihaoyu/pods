#
#  Be sure to run `pod spec lint PeerInfoUI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "PeerInfoUI"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of PeerInfoUI."
...
Hello
  ...
  spec.source       = { :git => "/PeerInfoUI.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "PeerInfoUI/**/*.{h,m,swift}"
