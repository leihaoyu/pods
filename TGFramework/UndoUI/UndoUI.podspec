#
#  Be sure to run `pod spec lint UndoUI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "UndoUI"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of UndoUI."
...
Hello
  ...
  spec.source       = { :git => "/UndoUI.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "UndoUI/**/*.{h,m,swift}"
