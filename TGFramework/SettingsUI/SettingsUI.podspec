#
#  Be sure to run `pod spec lint SettingsUI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "SettingsUI"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of SettingsUI."
...
Hello
  ...
  spec.source       = { :git => "/SettingsUI.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "SettingsUI/**/*.{h,m,swift}"
...
#  spec.dependency "TelegramCallsUI"
  ...
  spec.dependency "AuthorizationUtils"
  ...
  spec.dependency "PaymentMethodUI"
