#
#  Be sure to run `pod spec lint GraphUI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "GraphUI"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of GraphUI."
...
Hello
  ...
  spec.source       = { :git => "/GraphUI.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "GraphUI/**/*.{h,m,swift}"
