#
#  Be sure to run `pod spec lint NotificationSoundSelectionUI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "NotificationSoundSelectionUI"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of NotificationSoundSelectionUI."
...
Hello
  ...
  spec.homepage     = "/NotificationSoundSelectionUI"
  ...
  spec.source       = { :git => "/NotificationSoundSelectionUI.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "NotificationSoundSelectionUI/**/*.{h,m,swift}"
