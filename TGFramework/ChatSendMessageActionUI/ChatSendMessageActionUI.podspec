#
#  Be sure to run `pod spec lint ChatSendMessageActionUI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "ChatSendMessageActionUI"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of ChatSendMessageActionUI."
...
Hello
  ...
  spec.homepage     = "/ChatSendMessageActionUI"
  ...
  spec.source       = { :git => "/ChatSendMessageActionUI.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "ChatSendMessageActionUI/**/*.{h,m,swift}"
