#
#  Be sure to run `pod spec lint LegacyMediaPickerUI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "LegacyMediaPickerUI"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of LegacyMediaPickerUI."
...
Hello
  ...
  spec.homepage     = "/LegacyMediaPickerUI"
  ...
  spec.source       = { :git => "/LegacyMediaPickerUI.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "LegacyMediaPickerUI/**/*.{h,m,swift}"
