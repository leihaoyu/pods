#
#  Be sure to run `pod spec lint LanguageSuggestionUI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "LanguageSuggestionUI"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of LanguageSuggestionUI."
...
Hello
  ...
  spec.homepage     = "/LanguageSuggestionUI"
  ...
  spec.source       = { :git => "/LanguageSuggestionUI.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "LanguageSuggestionUI/**/*.{h,m,swift}"
