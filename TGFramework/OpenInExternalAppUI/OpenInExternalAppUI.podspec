#
#  Be sure to run `pod spec lint OpenInExternalAppUI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "OpenInExternalAppUI"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of OpenInExternalAppUI."
...
Hello
  ...
  spec.homepage     = "/OpenInExternalAppUI"
  ...
  spec.source       = { :git => "/OpenInExternalAppUI.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "OpenInExternalAppUI/**/*.{h,m,swift}"
