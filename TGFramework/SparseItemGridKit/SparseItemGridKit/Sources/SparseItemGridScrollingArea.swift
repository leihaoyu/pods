...
public final class MultilineText: Component {
    ...
    public final class View: UIView {
        ...
        func update(component: MultilineText, availableSize: CGSize, environment: Environment<Empty>, transition: TGTransition) -> CGSize {
...
public final class LottieAnimationComponent: Component {
    ...
    public final class View: UIView {
        ...
        func update(component: LottieAnimationComponent, availableSize: CGSize, environment: Environment<Empty>, transition: TGTransition) -> CGSize {
...
private final class ScrollingTooltipAnimationComponent: Component {
    ...
    public final class View: UIView {
        ...
        func update(component: ScrollingTooltipAnimationComponent, availableSize: CGSize, environment: Environment<Empty>, transition: TGTransition) -> CGSize {
...
public final class TooltipComponent: Component {
    ...
    public final class View: UIView {
        ...
        func update(component: TooltipComponent, availableSize: CGSize, environment: Environment<Empty>, transition: TGTransition) -> CGSize {
...
private final class RoundedRectangle: Component {
    ...
    final class View: UIView {
        ...
        func update(component: RoundedRectangle, availableSize: CGSize, environment: Environment<Empty>, transition: TGTransition) -> CGSize {
...
private final class ShadowRoundedRectangle: Component {
    ...
    final class View: UIView {
        ...
        func update(component: ShadowRoundedRectangle, availableSize: CGSize, environment: Environment<Empty>, transition: TGTransition) -> CGSize {
            let diameter = min(availableSize.width, availableSize.height)
...
public final class SparseItemGridScrollingArea: ASDisplayNode {
    ...
    private func updateLineIndicator(transition: ContainedViewLayoutTransition) {
        ...
        let mappedTransition: TGTransition
        switch transition {
        case .immediate:
            mappedTransition = .immediate
        case let .animated(duration, _):
            mappedTransition = TGTransition(animation: .curve(duration: duration, curve: .easeInOut))
        }
