#
#  Be sure to run `pod spec lint SparseItemGridKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "SparseItemGridKit"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of SparseItemGridKit."
...
Hello
  ...
  spec.homepage     = "/SparseItemGridKit"
  ...
  spec.source       = { :git => "/SparseItemGridKit.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "SparseItemGridKit/**/*.{h,m,swift}"
