#
#  Be sure to run `pod spec lint WebSearchUI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "WebSearchUI"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of WebSearchUI."
...
Hello
  ...
  spec.source       = { :git => "/WebSearchUI.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "WebSearchUI/**/*.{h,m,swift}"
