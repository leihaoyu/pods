#
#  Be sure to run `pod spec lint ShareItems.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "ShareItems"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of ShareItems."
...
Hello
  ...
  spec.source       = { :git => "/ShareItems.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "ShareItems/**/*.{h,m,swift}"
