#
#  Be sure to run `pod spec lint TextNodeWithEntities.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "TextNodeWithEntitiesKit"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of TextNodeWithEntities."
...
Hello
  ...
  spec.homepage     = "/TextNodeWithEntities"
  ...
  spec.source       = { :git => "/TextNodeWithEntities.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "TextNodeWithEntities/**/*.{h,m,swift}"
