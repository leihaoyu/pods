#
#  Be sure to run `pod spec lint SlotMachineAnimationNodeKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "SlotMachineAnimationNodeKit"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of SlotMachineAnimationNodeKit."
...
Hello
  ...
  spec.homepage     = "/SlotMachineAnimationNodeKit"
  ...
  spec.source       = { :git => "/SlotMachineAnimationNodeKit.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "SlotMachineAnimationNode/**/*.{h,m,swift}"
