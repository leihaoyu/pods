#
#  Be sure to run `pod spec lint WebUI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "WebUI"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of WebUI."
...
Hello
  ...
  spec.source       = { :git => "/WebUI.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "WebUI/**/*.{h,m,swift}"
