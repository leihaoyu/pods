#
#  Be sure to run `pod spec lint AppLock.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "AppLock"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of AppLock."
...
Hello
  ...
  spec.source       = { :git => "/AppLock.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "AppLock/**/*.{h,m,swift}"
