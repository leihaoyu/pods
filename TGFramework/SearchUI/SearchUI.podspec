#
#  Be sure to run `pod spec lint SearchUI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "SearchUI"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of SearchUI."
...
Hello
  ...
  spec.source       = { :git => "/SearchUI.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "SearchUI/**/*.{h,m,swift}"
