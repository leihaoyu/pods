#
#  Be sure to run `pod spec lint ChatTextLinkEditUI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "ChatTextLinkEditUI"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of ChatTextLinkEditUI."
...
Hello
  ...
  spec.homepage     = "/ChatTextLinkEditUI"
  ...
  spec.source       = { :git => "/ChatTextLinkEditUI.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "ChatTextLinkEditUI/**/*.{h,m,swift}"
