#
#  Be sure to run `pod spec lint EmojiSuggestionsComponentKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "EmojiSuggestionsComponentKit"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of EmojiSuggestionsComponentKit."
...
Hello
  ...
  spec.homepage     = "/EmojiSuggestionsComponentKit"
  ...
  spec.source       = { :git => "/EmojiSuggestionsComponentKit.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "EmojiSuggestionsComponentKit/**/*.{h,m,swift}"
