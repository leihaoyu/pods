...
public final class SheetComponent<ChildEnvironmentType: Equatable>: Component {
    ...
    public final class View: UIView, UIScrollViewDelegate {
        ...
        func update(component: SheetComponent<ChildEnvironmentType>, availableSize: CGSize, state: EmptyComponentState, environment: Environment<EnvironmentType>, transition: TGTransition) -> CGSize {
