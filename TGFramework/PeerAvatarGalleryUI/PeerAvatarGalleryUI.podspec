#
#  Be sure to run `pod spec lint PeerAvatarGalleryUI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "PeerAvatarGalleryUI"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of PeerAvatarGalleryUI."
...
Hello
  ...
  spec.homepage     = "/PeerAvatarGalleryUI"
  ...
  spec.source       = { :git => "/PeerAvatarGalleryUI.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "PeerAvatarGalleryUI/**/*.{h,m,swift}"
