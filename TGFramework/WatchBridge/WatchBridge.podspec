#
#  Be sure to run `pod spec lint WatchBridge.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "WatchBridge"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of WatchBridge."
...
Hello
  ...
  spec.source       = { :git => "/WatchBridge.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "WatchBridge/**/*.{h,m,swift}"
...
spec.dependency "WatchBridgeImpl"
end
