#
#  Be sure to run `pod spec lint SectionHeaderItemKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "SectionHeaderItemKit"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of SectionHeaderItemKit."
...
Hello
  ...
  spec.homepage     = "/SectionHeaderItemKit"
  ...
  spec.source       = { :git => "/SectionHeaderItemKit.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "SectionHeaderItemKit/**/*.{h,m,swift}"
