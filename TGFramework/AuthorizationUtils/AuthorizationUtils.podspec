#
#  Be sure to run `pod spec lint AuthorizationUtils.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "AuthorizationUtils"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of AuthorizationUtils."
...
Hello
  ...
  spec.homepage     = "/AuthorizationUtils"
  ...
  spec.source       = { :git => "/AuthorizationUtils.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "AuthorizationUtils/**/*.{h,m,swift}"
