#
#  Be sure to run `pod spec lint ContextUI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "ContextUI"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of ContextUI."
...
Hello
  ...
  spec.source       = { :git => "/ContextUI.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "ContextUI/**/*.{h,m,swift}"
