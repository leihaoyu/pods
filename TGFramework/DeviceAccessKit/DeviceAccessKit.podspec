#
#  Be sure to run `pod spec lint DeviceAccessKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "DeviceAccessKit"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of DeviceAccessKit."
...
Hello
  ...
  spec.source       = { :git => "/DeviceAccessKit.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "DeviceAccessKit/**/*.{h,m,swift}"
