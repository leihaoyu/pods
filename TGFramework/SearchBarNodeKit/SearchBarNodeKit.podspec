#
#  Be sure to run `pod spec lint SearchBarNodeKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "SearchBarNodeKit"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of SearchBarNodeKit."
...
Hello
  ...
  spec.homepage     = "/SearchBarNodeKit"
  ...
  spec.source       = { :git => "/SearchBarNodeKit.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "SearchBarNode/**/*.{h,m,swift}"
