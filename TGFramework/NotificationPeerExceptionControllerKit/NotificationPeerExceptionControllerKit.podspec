#
#  Be sure to run `pod spec lint NotificationPeerExceptionControllerKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "NotificationPeerExceptionControllerKit"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of NotificationPeerExceptionControllerKit."
...
Hello
  ...
  spec.homepage     = "/NotificationPeerExceptionControllerKit"
  ...
  spec.source       = { :git => "/NotificationPeerExceptionControllerKit.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "NotificationPeerExceptionControllerKit/**/*.{h,m,swift}"
