#
#  Be sure to run `pod spec lint ItemListPeerItemKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "ItemListPeerItemKit"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of ItemListPeerItemKit."
...
Hello
  ...
  spec.homepage     = "/ItemListPeerItemKit"
  ...
  spec.source       = { :git => "/ItemListPeerItemKit.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "ItemListPeerItemKit/**/*.{h,m,swift}"
