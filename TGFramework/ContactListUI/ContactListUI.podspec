#
#  Be sure to run `pod spec lint ContactListUI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "ContactListUI"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of ContactListUI."
...
Hello
  ...
  spec.source       = { :git => "/ContactListUI.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "ContactListUI/**/*.{h,m,swift}"
