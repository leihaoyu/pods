#
#  Be sure to run `pod spec lint NotificationExceptionsScreenKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "NotificationExceptionsScreenKit"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of NotificationExceptionsScreenKit."
...
Hello
  ...
  spec.homepage     = "/NotificationExceptionsScreenKit"
  ...
  spec.source       = { :git => "/NotificationExceptionsScreenKit.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "NotificationExceptionsScreenKit/**/*.{h,m,swift}"
