#
#  Be sure to run `pod spec lint TabBarUI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "TabBarUI"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of TabBarUI."
...
Hello
  ...
  spec.source       = { :git => "/TabBarUI.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "TabBarUI/**/*.{h,m,swift}"
