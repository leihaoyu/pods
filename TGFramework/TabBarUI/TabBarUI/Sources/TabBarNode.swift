...
public final class TabBarNodeItem {
    public let item: UITabBarItem
    public let contextActionType: TabBarItemContextActionType
    
    public init(item: UITabBarItem, contextActionType: TabBarItemContextActionType) {
        self.item = item
        self.contextActionType = contextActionType
    }
}

@objc public class TabBarNode: ASDisplayNode {
    public var tabBarItems: [TabBarNodeItem] = [] {
        didSet {
    ...
    public init(theme: TabBarControllerTheme, itemSelected: @escaping (Int, Bool, [ASDisplayNode]) -> Void, contextAction: @escaping (Int, ContextExtractedContentContainingNode, ContextGesture) -> Void, swipeAction: @escaping (Int, TabBarItemSwipeDirection) -> Void) {
    ...
    public func updateLayout(size: CGSize, leftInset: CGFloat, rightInset: CGFloat, additionalSideInsets: UIEdgeInsets, bottomInset: CGFloat, transition: ContainedViewLayoutTransition) {
