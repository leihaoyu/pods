#
#  Be sure to run `pod spec lint DateSelectionUI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "DateSelectionUI"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of DateSelectionUI."
...
Hello
  ...
  spec.source       = { :git => "/DateSelectionUI.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "DateSelectionUI/**/*.{h,m,swift}"
