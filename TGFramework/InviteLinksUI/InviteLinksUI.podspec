#
#  Be sure to run `pod spec lint InviteLinksUI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "InviteLinksUI"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of InviteLinksUI."
...
Hello
  ...
  spec.source       = { :git => "/InviteLinksUI.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "InviteLinksUI/**/*.{h,m,swift}"
  ...
  spec.dependency "SectionHeaderItemKit"
