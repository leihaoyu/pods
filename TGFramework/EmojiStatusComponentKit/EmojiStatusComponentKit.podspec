#
#  Be sure to run `pod spec lint EmojiStatusComponentKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "EmojiStatusComponentKit"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of EmojiStatusComponentKit."
  ...
  EmojiStatusComponentKit
                   DESC

  spec.homepage     = "http://EXAMPLE/EmojiStatusComponentKit"
  ...
  spec.source       = { :git => "http:///EmojiStatusComponentKit.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "EmojiStatusComponentKit/**/*.{h,swift,m}"
