#
#  Be sure to run `pod spec lint TelegramPermissionsUI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "TelegramPermissionsUI"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of TelegramPermissionsUI."
...
Hello
  ...
  spec.homepage     = "/TelegramPermissionsUI"
  ...
  spec.source       = { :git => "/TelegramPermissionsUI.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "TelegramPermissionsUI/**/*.{h,m,swift}"
