#
#  Be sure to run `pod spec lint EmojiStatusSelectionComponentKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "EmojiStatusSelectionComponentKit"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of EmojiStatusSelectionComponentKit."
  ...
  EmojiStatusSelectionComponent
                   DESC

  spec.homepage     = "http://EXAMPLE/EmojiStatusSelectionComponentKit"
  ...
  spec.source       = { :git => "http:///EmojiStatusSelectionComponentKit.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "EmojiStatusSelectionComponentKit/**/*.{h,m,swift}"
