#
#  Be sure to run `pod spec lint TelegramStringFormatting.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "TelegramStringFormatting"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of TelegramStringFormatting."
  ...
  spec.homepage     = "http://EXAMPLE/TelegramStringFormatting"
  ...
  spec.source       = { :git => "http:///TelegramStringFormatting.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "TelegramStringFormatting/**/*.{h,swift,m}"
