#
#  Be sure to run `pod spec lint ItemListStickerPackItemKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "ItemListStickerPackItemKit"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of ItemListStickerPackItemKit."
...
Hello
  ...
  spec.homepage     = "/ItemListStickerPackItemKit"
  ...
  spec.source       = { :git => "/ItemListStickerPackItemKit.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "ItemListStickerPackItemKit/**/*.{h,m,swift}"
