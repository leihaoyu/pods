#
#  Be sure to run `pod spec lint QrCodeUI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "QrCodeUI"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of QrCodeUI."
...
Hello
  ...
  spec.source       = { :git => "/QrCodeUI.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "QrCodeUI/**/*.{h,m,swift}"
