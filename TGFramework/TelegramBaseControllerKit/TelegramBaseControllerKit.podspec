#
#  Be sure to run `pod spec lint TelegramBaseControllerKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "TelegramBaseControllerKit"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of TelegramBaseControllerKit."
...
Hello
  ...
  spec.homepage     = "/TelegramBaseControllerKit"
  ...
  spec.source       = { :git => "/TelegramBaseControllerKit.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "TelegramBaseControllerKit/**/*.{h,m,swift}"
