...
open class ComponentState {
    var _updated: ((TGTransition) -> Void)?
    var isUpdated: Bool = false
    
    public init() {
    }
    
    public final func updated(transition: TGTransition = .immediate) {
        self.isUpdated = true
...
public protocol _TypeErasedComponent {
    ...
    func _update(view: UIView, availableSize: CGSize, environment: Any, transition: TGTransition) -> CGSize
...
public class AnyComponent<EnvironmentType>: _TypeErasedComponent, Equatable {
    ...
    public func _update(view: UIView, availableSize: CGSize, environment: Any, transition: TGTransition) -> CGSize {
