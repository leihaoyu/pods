...
public final class ComponentHostView<EnvironmentType>: UIView {
    ...
    public func update(transition: TGTransition, component: AnyComponent<EnvironmentType>, @EnvironmentBuilder environment: () -> Environment<EnvironmentType>, forceUpdate: Bool = false, containerSize: CGSize) -> CGSize {
    ...
    private func _update(transition: TGTransition, component: AnyComponent<EnvironmentType>, maybeEnvironment: () -> Environment<EnvironmentType>, updateEnvironment: Bool, forceUpdate: Bool, containerSize: CGSize) -> CGSize {
...
public final class ComponentView<EnvironmentType> {
    ...
    public func updateEnvironment(transition: TGTransition, @EnvironmentBuilder environment: () -> Environment<EnvironmentType>) -> CGSize? {
