...
public final class Button: Component {
    ...
    public final class View: UIButton, ComponentTaggedView {
        ...
        private func updateAlpha(transition: TGTransition) {
        ...
        func update(component: Button, availableSize: CGSize, state: EmptyComponentState, environment: Environment<Empty>, transition: TGTransition) -> CGSize {
