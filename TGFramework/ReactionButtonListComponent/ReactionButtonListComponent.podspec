#
#  Be sure to run `pod spec lint ReactionButtonListComponent.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "ReactionButtonListComponent"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of ReactionButtonListComponent."
  ...
  spec.homepage     = "http://EXAMPLE/ReactionButtonListComponent"
  ...
  spec.source       = { :git => "http:///ReactionButtonListComponent.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "ReactionButtonListComponent/**/*.{h,swift,m}"
