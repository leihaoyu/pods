#
#  Be sure to run `pod spec lint ChatTimerScreenKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "ChatTimerScreenKit"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of ChatTimerScreenKit."
...
Hello
  ...
  spec.homepage     = "/ChatTimerScreenKit"
  ...
  spec.source       = { :git => "/ChatTimerScreenKit.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "ChatTimerScreenKit/**/*.{h,m,swift}"
