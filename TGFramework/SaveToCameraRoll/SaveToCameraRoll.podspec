#
#  Be sure to run `pod spec lint SaveToCameraRoll.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "SaveToCameraRoll"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of SaveToCameraRoll."
...
Hello
  ...
  spec.homepage     = "/SaveToCameraRoll"
  ...
  spec.source       = { :git => "/SaveToCameraRoll.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "SaveToCameraRoll/**/*.{h,m,swift}"
