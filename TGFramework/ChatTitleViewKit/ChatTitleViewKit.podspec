#
#  Be sure to run `pod spec lint ChatTitleViewKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "ChatTitleViewKit"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of ChatTitleViewKit."
...
Hello
  ...
  spec.homepage     = "/ChatTitleViewKit"
  ...
  spec.source       = { :git => "/ChatTitleViewKit.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "ChatTitleViewKit/**/*.{h,m,swift}"
