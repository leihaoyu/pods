#
#  Be sure to run `pod spec lint AvatarEditorScreenKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "AvatarEditorScreenKit"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of AvatarEditorScreenKit."
...
Hello
  ...
  spec.homepage     = "/AvatarEditorScreenKit"
  ...
  spec.source       = { :git => "/AvatarEditorScreenKit.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "AvatarEditorScreenKit/**/*.{h,m,swift}"
