...
final class AvatarPreviewComponent: Component {
    ...
    final class View: UIView, UITextFieldDelegate {
        ...
        func update(component: AvatarPreviewComponent, availableSize: CGSize, state: EmptyComponentState, environment: Environment<EnvironmentType>, transition: TGTransition) -> CGSize {
    ...
    public func update(view: View, availableSize: CGSize, state: State, environment: Environment<EnvironmentType>, transition: TGTransition) -> CGSize {
