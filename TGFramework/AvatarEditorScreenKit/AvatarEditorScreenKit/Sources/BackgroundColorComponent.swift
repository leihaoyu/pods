...
final class BackgroundColorComponent: Component {
    ...
    class View: UIView {
        ...
        func update(component: BackgroundColorComponent, availableSize: CGSize, state: EmptyComponentState, environment: Environment<Empty>, transition: TGTransition) -> CGSize {
...
final class BackgroundSwatchComponent: Component {
    ...
    final class View: UIButton {
        ...
        func update(component: BackgroundSwatchComponent, availableSize: CGSize, state: EmptyComponentState, environment: Environment<Empty>, transition: TGTransition) -> CGSize {
