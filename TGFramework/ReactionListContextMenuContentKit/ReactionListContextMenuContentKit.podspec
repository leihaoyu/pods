#
#  Be sure to run `pod spec lint ReactionListContextMenuContentKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "ReactionListContextMenuContentKit"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of ReactionListContextMenuContentKit."
...
Hello
  ...
  spec.homepage     = "/ReactionListContextMenuContentKit"
  ...
  spec.source       = { :git => "/ReactionListContextMenuContentKit.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "ReactionListContextMenuContentKit/**/*.{h,m,swift}"
