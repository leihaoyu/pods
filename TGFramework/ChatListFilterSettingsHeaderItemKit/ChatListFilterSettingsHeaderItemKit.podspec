#
#  Be sure to run `pod spec lint ChatListFilterSettingsHeaderItemKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "ChatListFilterSettingsHeaderItemKit"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of ChatListFilterSettingsHeaderItemKit."
...
Hello
  ...
  spec.homepage     = "/ChatListFilterSettingsHeaderItemKit"
  ...
  spec.source       = { :git => "/ChatListFilterSettingsHeaderItemKit.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "ChatListFilterSettingsHeaderItemKit/**/*.{h,m,swift}"
