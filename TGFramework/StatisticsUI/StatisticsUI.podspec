#
#  Be sure to run `pod spec lint StatisticsUI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "StatisticsUI"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of StatisticsUI."
...
Hello
  ...
  spec.source       = { :git => "/StatisticsUI.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "StatisticsUI/**/*.{h,m,swift}"
  ...
  spec.dependency "GraphCore"
  spec.dependency "GraphUI"
