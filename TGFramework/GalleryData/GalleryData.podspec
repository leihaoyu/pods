#
#  Be sure to run `pod spec lint GalleryData.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "GalleryData"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of GalleryData."
...
Hello
  ...
  spec.source       = { :git => "/GalleryData.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "GalleryData/**/*.{h,m,swift}"
