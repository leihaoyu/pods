#
#  Be sure to run `pod spec lint BrowserUI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "BrowserUI"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of BrowserUI."
...
Hello
  ...
  spec.source       = { :git => "/BrowserUI.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "BrowserUI/**/*.{h,m,swift}"
