#
#  Be sure to run `pod spec lint ArchivedStickerPacksNotice.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "ArchivedStickerPacksNotice"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of ArchivedStickerPacksNotice."
...
Hello
  ...
  spec.homepage     = "/ArchivedStickerPacksNotice"
  ...
  spec.source       = { :git => "/ArchivedStickerPacksNotice.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "ArchivedStickerPacksNotice/**/*.{h,m,swift}"
