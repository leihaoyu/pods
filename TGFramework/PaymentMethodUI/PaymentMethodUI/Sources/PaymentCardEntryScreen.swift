...
import AnimatedStickerComponentKit
import SolidRoundedButtonComponentKit
import MultilineTextComponentKit
import PresentationDataUtils
import PrefixSectionGroupComponentKit
import TextInputComponentKit
import CreditCardInputComponentKit
import Markdown
...
public final class ScrollComponent<ChildEnvironment: Equatable>: Component {
    ...
    public final class View: UIScrollView {
        ...
        func update(component: ScrollComponent<ChildEnvironment>, availableSize: CGSize, state: EmptyComponentState, environment: Environment<ChildEnvironment>, transition: TGTransition) -> CGSize {
    ...
    public func update(view: View, availableSize: CGSize, state: EmptyComponentState, environment: Environment<ChildEnvironment>, transition: TGTransition) -> CGSize {
