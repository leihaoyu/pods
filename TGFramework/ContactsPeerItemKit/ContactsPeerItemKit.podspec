#
#  Be sure to run `pod spec lint ContactsPeerItemKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "ContactsPeerItemKit"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of ContactsPeerItemKit."
...
Hello
  ...
  spec.homepage     = "/ContactsPeerItemKit"
  ...
  spec.source       = { :git => "/ContactsPeerItemKit.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "ContactsPeerItemKit/**/*.{h,m,swift}"
