#
#  Be sure to run `pod spec lint TranslateUI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "TranslateUI"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of TranslateUI."
...
Hello
  ...
  spec.source       = { :git => "/TranslateUI.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "TranslateUI/**/*.{h,m,swift}"
