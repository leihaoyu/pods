#
#  Be sure to run `pod spec lint AttachmentUI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "AttachmentUI"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of AttachmentUI."
...
Hello
  ...
  spec.source       = { :git => "/AttachmentUI.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "AttachmentUI/**/*.{h,m,swift}"
