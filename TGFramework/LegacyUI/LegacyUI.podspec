#
#  Be sure to run `pod spec lint LegacyUI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "LegacyUI"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of LegacyUI."
...
Hello
  ...
  spec.source       = { :git => "/LegacyUI.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "LegacyUI/**/*.{h,m,swift}"
