#
#  Be sure to run `pod spec lint ChatImportUI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "ChatImportUI"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of ChatImportUI."
...
Hello
  ...
  spec.source       = { :git => "/ChatImportUI.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "ChatImportUI/**/*.{h,m,swift}"
