#
#  Be sure to run `pod spec lint PasscodeUI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "PasscodeUI"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of PasscodeUI."
...
Hello
  ...
  spec.source       = { :git => "/PasscodeUI.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "PasscodeUI/**/*.{h,m,swift}"
  ...
  spec.dependency "PasscodeInputFieldNodeKit"
  spec.dependency "MonotonicTime"
