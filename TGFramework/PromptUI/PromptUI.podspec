#
#  Be sure to run `pod spec lint PromptUI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "PromptUI"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of PromptUI."
...
Hello
  ...
  spec.source       = { :git => "/PromptUI.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "PromptUI/**/*.{h,m,swift}"
