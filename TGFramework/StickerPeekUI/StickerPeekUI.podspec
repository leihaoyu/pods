#
#  Be sure to run `pod spec lint StickerPeekUI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "StickerPeekUI"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of StickerPeekUI."
...
Hello
  ...
  spec.source       = { :git => "/StickerPeekUI.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "StickerPeekUI/**/*.{h,m,swift}"
