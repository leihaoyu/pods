#
#  Be sure to run `pod spec lint StickerPackPreviewUI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "StickerPackPreviewUI"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of StickerPackPreviewUI."
...
Hello
  ...
  spec.homepage     = "/StickerPackPreviewUI"
  ...
  spec.source       = { :git => "/StickerPackPreviewUI.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "StickerPackPreviewUI/**/*.{h,m,swift}"
