#
#  Be sure to run `pod spec lint BotPaymentsUI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "BotPaymentsUI"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of BotPaymentsUI."
...
Hello
  ...
  spec.source       = { :git => "/BotPaymentsUI.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "BotPaymentsUI/**/*.{h,m,swift}"
