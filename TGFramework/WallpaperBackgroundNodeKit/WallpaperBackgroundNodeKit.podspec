#
#  Be sure to run `pod spec lint WallpaperBackgroundNodeKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "WallpaperBackgroundNodeKit"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of WallpaperBackgroundNodeKit."
...
Hello
  ...
  spec.homepage     = "/WallpaperBackgroundNodeKit"
  ...
  spec.source       = { :git => "/WallpaperBackgroundNodeKit.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "WallpaperBackgroundNodeBundleKit/**/*.{h,m,swift}"
