#
#  Be sure to run `pod spec lint ListMessageItemKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "ListMessageItemKit"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of ListMessageItemKit."
...
Hello
  ...
  spec.homepage     = "/ListMessageItemKit"
  ...
  spec.source       = { :git => "/ListMessageItemKit.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "ListMessageItemKit/**/*.{h,m,swift}"
