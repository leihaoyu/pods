#
#  Be sure to run `pod spec lint TooltipUI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "TooltipUI"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of TooltipUI."
...
Hello
  ...
  spec.source       = { :git => "/TooltipUI.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "TooltipUI/**/*.{h,m,swift}"
