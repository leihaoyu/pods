#
#  Be sure to run `pod spec lint TelegramAnimatedStickerNode.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "TelegramAnimatedStickerNode"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of TelegramAnimatedStickerNode."
  ...
  spec.homepage     = "http://EXAMPLE/TelegramAnimatedStickerNode"
  ...
  spec.source       = { :git => "http:///TelegramAnimatedStickerNode.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "TelegramAnimatedStickerNode/**/*.{h,swift,m}"
