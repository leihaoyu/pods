#
#  Be sure to run `pod spec lint MediaPickerUI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "MediaPickerUI"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of MediaPickerUI."
...
Hello
  ...
  spec.source       = { :git => "/MediaPickerUI.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "MediaPickerUI/**/*.{h,m,swift}"
