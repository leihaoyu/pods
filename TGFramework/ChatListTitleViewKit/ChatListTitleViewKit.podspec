#
#  Be sure to run `pod spec lint ChatListTitleViewKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "ChatListTitleViewKit"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of ChatListTitleViewKit."
...
Hello
  ...
  spec.homepage     = "/ChatListTitleViewKit"
  ...
  spec.source       = { :git => "/ChatListTitleViewKit.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "ChatListTitleViewKit/**/*.{h,m,swift}"
