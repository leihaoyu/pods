#
#  Be sure to run `pod spec lint ForumCreateTopicScreenKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "ForumCreateTopicScreenKit"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of ForumCreateTopicScreenKit."
...
Hello
  ...
  spec.homepage     = "/ForumCreateTopicScreenKit"
  ...
  spec.source       = { :git => "/ForumCreateTopicScreenKit.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "ForumCreateTopicScreenKit/**/*.{h,m,swift}"
