#
#  Be sure to run `pod spec lint PassportUI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "PassportUI"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of PassportUI."
...
Hello
  ...
  spec.source       = { :git => "/PassportUI.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "PassportUI/**/*.{h,m,swift}"
