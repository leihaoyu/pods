#
#  Be sure to run `pod spec lint FeaturedStickersScreenKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "FeaturedStickersScreenKit"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of FeaturedStickersScreenKit."
...
Hello
  ...
  spec.homepage     = "/FeaturedStickersScreenKit"
  ...
  spec.source       = { :git => "/FeaturedStickersScreenKit.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "FeaturedStickersScreenKit/**/*.{h,m,swift}"
