#
#  Be sure to run `pod spec lint HashtagSearchUI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "HashtagSearchUI"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of HashtagSearchUI."
...
Hello
  ...
  spec.source       = { :git => "/HashtagSearchUI.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "HashtagSearchUI/**/*.{h,m,swift}"
