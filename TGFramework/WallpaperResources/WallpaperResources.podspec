#
#  Be sure to run `pod spec lint WallpaperResources.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "WallpaperResources"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of WallpaperResources."
...
Hello
  ...
  spec.homepage     = "/WallpaperResources"
  ...
  spec.source       = { :git => "/WallpaperResources.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "WallpaperResources/**/*.{h,m,swift}"
