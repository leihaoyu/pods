#
#  Be sure to run `pod spec lint PeerInfoAvatarListNodeKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "PeerInfoAvatarListNodeKit"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of PeerInfoAvatarListNodeKit."
...
Hello
  ...
  spec.homepage     = "/PeerInfoAvatarListNodeKit"
  ...
  spec.source       = { :git => "/PeerInfoAvatarListNodeKit.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "PeerInfoAvatarListNodeKit/**/*.{h,m,swift}"
