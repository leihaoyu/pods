#
#  Be sure to run `pod spec lint PremiumUI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "PremiumUI"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of PremiumUI."
...
Hello
  ...
  spec.source       = { :git => "/PremiumUI.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "PremiumUI/**/*.{h,m,swift}"
  ...
  spec.dependency "ReactionSelectionNode"
  ...
  spec.dependency "MultilineTextWithEntitiesComponentKit"
