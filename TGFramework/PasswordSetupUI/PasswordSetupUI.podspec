#
#  Be sure to run `pod spec lint PasswordSetupUI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "PasswordSetupUI"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of PasswordSetupUI."
...
Hello
  ...
  spec.source       = { :git => "/PasswordSetupUI.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "PasswordSetupUI/**/*.{h,m,swift}"
