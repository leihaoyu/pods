#
#  Be sure to run `pod spec lint DatePickerNodeKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "DatePickerNodeKit"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of DatePickerNodeKit."
...
Hello
  ...
  spec.homepage     = "/DatePickerNodeKit"
  ...
  spec.source       = { :git => "/DatePickerNodeKit.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "DatePickerNodeKit/**/*.{h,m,swift}"
