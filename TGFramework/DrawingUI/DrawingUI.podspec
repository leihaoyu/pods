#
#  Be sure to run `pod spec lint DrawingUI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "DrawingUI"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of DrawingUI."
...
Hello
  ...
  spec.source       = { :git => "/DrawingUI.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "DrawingUI/**/*.{h,m,swift}"
